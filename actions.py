...
if __name__ == '__main__':
    import config
    #change dry_run to True or Flase from here to toggle would move on if True and vice versa
    organize_folder(config.TARGET_FOLDER, dry_run=False)            
    organize_subfolders(config.TARGET_FOLDER, dry_run=False)        